...
import '../../Styles/Mobile/MobileDetails.css';
...
class MobileDetails extends react.Component {
    ...
    componentDidMount() {
        ...
        axios({
            ...
            Itemdetail: res.data.mobile_by_prodID,
            Itemdescription: res.data.mobile_by_prodID.small_description.split('\n'),
        })).catch(err => console.log(err))
        axios({
            url: `https://amazon-clone-db.herokuapp.com/mobile/basic/${productId}`,
            Headers: {
                'content-type': 'application/json'
            },
            method: 'GET'
        }).then(res => this.setState({
            ItembasicDetail: res.data.mobile_basic_detail_prodID
        })).catch(err => console.log(err))
    ...
    render() {
        ...
        return (
            ...
            <div className="container-fluid">
                <div className="row">
                    <div className="mobile-item-img col-5 col-sm-4 col-md-4 col-lg-4 col-xl-4">
                    ...
                    <div className="mobile-item-detail col-7 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="mobile-item-name">
                            {Itemdetail.name}
                        </div>
                        <div className="mobile-item-brand-url">
                        ...
                        {ItembasicDetail.is_amazon_choice === true ? <img className="mobile-item-amazon-choice" src="https://storage.googleapis.com/mw-imagelibrary/amazon-choice.png"></img> : null}
                        {ItembasicDetail.is_limited_deal === true ? <img className="mobile-item-amazon-limited-deal" src="https://www.pngall.com/wp-content/uploads/2016/06/Limited-offer-Free-Download-PNG.png"></img> : null}
                        <hr className="item-detail-split" />
                        <div className="mobile-item-price-deliver">
                            <div className="mobile-item-price">
                                Price: {ItembasicDetail.price_string}
                            </div>
                            <div className="mobile-item-has-prime">
                            ...
                            <div className="mobile-item-deliver">
                    ...
                    <div className="mobile-cart-buy col-12 col-sm-2 col-md-2 col-lg-2 col-xl-2">
