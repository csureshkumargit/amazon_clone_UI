...
import '../../Styles/HomeAppliances/HomeApplianceDetails.css';
...
class HomeApplianceDetails extends react.Component {
    constructor() {
        super();
        this.state = {
            Itemdetail: {},
    ...
    componentDidMount() {
        ...
        axios({
            ...
            Itemdetail: res.data.appliance_by_prodID,
            Itemdescription: res.data.appliance_by_prodID.small_description.split('\n'),
        })).catch(err => console.log(err))
        axios({
            url: `https://amazon-clone-db.herokuapp.com/appliances/basic/${productId}`,
            Headers: {
                'content-type': 'application/json'
            },
            method: 'GET'
        }).then(res => this.setState({
            ItembasicDetail: res.data.appliance_basic_detail_prodID
        })).catch(err => console.log(err))
    ...
    render() {
        ...
        return (
            ...
            <div className="container-fluid">
                <div className="row">
                    <div className="home-appl-item-img col-5 col-sm-4 col-md-4 col-lg-4 col-xl-4">
                    ...
                    <div className="home-appl-item-detail col-7 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="home-appl-item-name">
                            {Itemdetail.name}
                        </div>
                        <div className="home-appl-item-brand-url">
                            <a href={Itemdetail.brand_url}>{Itemdetail.brand}</a>
                        </div>
                        <div className="home-appl-item-rating">
                            {Itemdetail.average_rating} rating | {Itemdetail.total_reviews} reviews | {Itemdetail.total_answered_questions} + answered questions
                        </div>
                        {ItembasicDetail.is_amazon_choice === true ? <img className="home-appl-item-amazon-choice" src="https://storage.googleapis.com/mw-imagelibrary/amazon-choice.png"></img> : null}
                        {ItembasicDetail.is_limited_deal === true ? <img className="home-appl-item-amazon-limited-deal" src="https://www.pngall.com/wp-content/uploads/2016/06/Limited-offer-Free-Download-PNG.png"></img> : null}
                        <hr className="item-detail-split" />
                        <div className="home-appl-item-price-deliver">
                            <div className="home-appl-item-price">
                                Price: {ItembasicDetail.price_string}
                            </div>
                            <div className="home-appl-item-has-prime">
                            ...
                            <div className="home-appl-item-deliver">
                    ...
                    <div className="home-appl-cart-buy col-12 col-sm-2 col-md-2 col-lg-2 col-xl-2">
