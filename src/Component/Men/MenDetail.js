...
import '../../Styles/Men/MenDetail.css';
...
class MenDetails extends react.Component {
    constructor() {
        super();
        this.state = {
            Itemdetail: {},
    ...
    componentDidMount() {
        ...
        axios({
            url: `https://amazon-clone-db.herokuapp.com/fashionmen/details/${productId}`,
            Headers: {
                'content-type': 'application/json'
            },
            method: 'GET'
        }).then(res => this.setState({
            Itemdetail: res.data.fashion_men_det_prodID,
            Itemdescription: res.data.fashion_men_det_prodID.small_description.split('\n'),
        })).catch(err => console.log(err))
        axios({
            url: `https://amazon-clone-db.herokuapp.com/fashionmen/basic/${productId}`,
            Headers: {
                'content-type': 'application/json'
            },
            method: 'GET'
        }).then(res => this.setState({
            ItembasicDetail: res.data.fashion_men_basic_detail_prodID
        })).catch(err => console.log(err))
    ...
    render() {
        ...
        return (
            ...
            <div className="container-fluid">
                <div className="row">
                    <div className="men-item-img col-5 col-sm-4 col-md-4 col-lg-4 col-xl-4">
                    ...
                    <div className="men-item-detail col-7 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="men-item-name">
                            {Itemdetail.name}
                        </div>
                        <div className="men-item-brand-url">
                            <a href={Itemdetail.brand_url}>{Itemdetail.brand}</a>
                        </div>
                        <div className="men-item-rating">
                            {Itemdetail.average_rating} rating | {Itemdetail.total_reviews} reviews | {Itemdetail.total_answered_questions} + answered questions
                        </div>
                        {ItembasicDetail.is_amazon_choice === true ? <img className="men-item-amazon-choice" src="https://storage.googleapis.com/mw-imagelibrary/amazon-choice.png"></img> : null}
                        {ItembasicDetail.is_limited_deal === true ? <img className="men-item-amazon-limited-deal" src="https://www.pngall.com/wp-content/uploads/2016/06/Limited-offer-Free-Download-PNG.png"></img> : null}
                        <hr className="item-detail-split" />
                        <div className="men-item-price-deliver">
                            <div className="men-item-price">
                                Price: {ItembasicDetail.price_string}
                            </div>
                            <div className="men-item-has-prime">
                            ...
                            <div className="men-item-deliver">
                    ...
                    <div className="men-cart-buy col-12 col-sm-2 col-md-2 col-lg-2 col-col-xl-2">
...
export default WithRouter(MenDetails);